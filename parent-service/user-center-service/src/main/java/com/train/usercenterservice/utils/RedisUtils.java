...
public class RedisUtils {
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<String>> zSetRangeWithScores(String key, long start,
                                                                      long end) {
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<String>> zSetRangeByScoreWithScores(String key,
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<String>> zSetReverseRangeWithScores(String key,
                                                                             long start, long end) {
     ...
     * @return
     */
    public Set<ZSetOperations.TypedTuple<String>> zSetReverseRangeByScoreWithScores(
